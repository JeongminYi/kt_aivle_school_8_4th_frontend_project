      ...
      const response = await fetch(
          'https://api.openai.com/v1/images/generations', {
            ...
            body: JSON.stringify({
              ...
              size: selectedDalleVersion === 'dall-e-3' ? '1024x1792'
                  : '512x512',
              quality: selectedDalleVersion === 'dall-e-3' ? 'standard'
                  : undefined,
              n: 1,
            }),
          });
        ...
        <Paper elevation={5} sx={{
          ...
          {!numericBookId && (
              <Alert severity="error" sx={{mb: 4}}>
                현재 Book ID를 찾을 수 없습니다. 경로 파라미터 이름이 <strong>:bookId</strong>인지,
                또는
              ...
              <Alert severity={messageSeverity} sx={{
                ...
                borderLeft: `4px solid ${messageSeverity === 'info'
                    ? customColors.infoIndigo : messageSeverity === 'warning'
                        ? '#ff9800' : messageSeverity === 'success' ? '#4CAF50'
                            : '#F44336'}`,
          ...
          <Grid container spacing={{xs: 4, sm: 6, lg: 8}}
            ...
            <Grid item xs={12} sm={5}>
              ...
              <Paper elevation={6} sx={{
                ...
                <Box sx={{
                  ...
                  <img src={generatedImageUrl ? generatedImageUrl
                      : MOCK_COVER_URL} alt="Current Book Cover" style={{
                    width: '100%',
                    height: '100%',
                    objectFit: 'cover'
                  }} onError={(e) => {
            ...
            <Grid item xs={12} sm={7}>
              ...
              <Paper elevation={1} sx={{
                ...
                <Grid container spacing={2} alignItems="flex-end">
                  <Grid item xs={12} sm={6}>
                    <TextField fullWidth label="API Key (보안 입력)" type="password"
                               value={apiKey}
                               onChange={(e) => setApiKey(e.target.value)}
                               placeholder="sk-..." variant="outlined"
                               size="small" sx={{
                  ...
                  <Grid item xs={12} sm={6}>
                    <SelectInput options={dalleOptions} label="AI 모델 선택"
              ...
              <TextField fullWidth label="AI 표지 생성 프롬프트" multiline rows={7}
                         value={prompt}
                         onChange={(e) => setPrompt(e.target.value)}
                         placeholder="도서의 주제나 원하는 스타일을 상세하게 묘사해주세요."
                         variant="outlined" sx={{
                mb: 4,
              ...
              <Button fullWidth variant="contained" color="primary" size="large"
                      startIcon={isLoading ? <CircularProgress size={20}
                                                               color="inherit"/>
                          : <RefreshIcon/>} onClick={handleRegenerateCover}
            ...
            <Paper elevation={4} sx={{
              ...
              <Button fullWidth variant="contained" color="success"
                      startIcon={isRegistering ? <CircularProgress size={20}
                                                                   color="inherit"/>
                          : <CheckCircleIcon/>} onClick={handleRegisterCover}
                      disabled={isRegistering || !numericBookId}
